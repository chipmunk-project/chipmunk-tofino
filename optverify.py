...
if (len(sys.argv) < 4):
  print("Usage: " + sys.argv[0] + " sketch1_name sketch2_name transform_file")
  sys.exit(1)
else:
  ...
  assert(pickle.load(open(sketch1_name + ".pickle", "rb")).num_fields_in_prog_ ==
         pickle.load(open(sketch2_name + ".pickle", "rb")).num_fields_in_prog_)
  assert(pickle.load(open(sketch1_name + ".pickle", "rb")).num_state_vars_ ==
         pickle.load(open(sketch2_name + ".pickle", "rb")).num_state_vars_)
  num_fields_in_prog  = pickle.load(open(sketch1_name + ".pickle", "rb")).num_fields_in_prog_
  num_state_vars      = pickle.load(open(sketch1_name + ".pickle", "rb")).num_state_vars_
  ...
  opt_verifier        = opt_verify_template.render(
                        ...
                        hole1_arguments    = pickle.load(open(sketch1_name + ".pickle", "rb")).hole_arguments_,
                        hole2_arguments    = pickle.load(open(sketch2_name + ".pickle", "rb")).hole_arguments_,
                        sketch1_holes      = pickle.load(open(sketch1_name + ".pickle", "rb")).holes_,
                        sketch2_holes      = pickle.load(open(sketch2_name + ".pickle", "rb")).holes_,
                        sketch1_asserts    = pickle.load(open(sketch1_name + ".pickle", "rb")).constraints_,
                        sketch2_asserts    = pickle.load(open(sketch2_name + ".pickle", "rb")).constraints_,
